        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .hasAnyRole("ADMIN", "EXECUTIVE_VIEWER", "DELIVERY_HEAD",
                                                                "DELIVERY_MANAGER", "TL",
                                                ...
                                                .hasAnyRole("ADMIN", "CLIENT_VIEWER", "EXECUTIVE_VIEWER",
                                                                "DELIVERY_HEAD", "DELIVERY_MANAGER", "TL")
                                                ...
                                                // Project File APIs
                                                .requestMatchers(HttpMethod.GET, "/api/projects/*/files",
                                                                "/api/projects/files/*/download")
                                                .hasAnyRole("ADMIN", "CLIENT_VIEWER", "EXECUTIVE_VIEWER",
                                                                "DELIVERY_HEAD", "DELIVERY_MANAGER", "TL",
                                                                "TEAM_MEMBER")

                                                .requestMatchers(HttpMethod.POST, "/api/projects/*/files")
                                                .hasAnyRole("ADMIN", "DELIVERY_HEAD", "DELIVERY_MANAGER", "TL")

                                                .requestMatchers(HttpMethod.DELETE, "/api/projects/files/*")
                                                .hasAnyRole("ADMIN", "DELIVERY_HEAD", "DELIVERY_MANAGER", "TL")
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/support-tickets",
                                                                "/api/support-tickets/**")
                                                .hasAnyRole("ADMIN", "CLIENT_VIEWER", "DELIVERY_HEAD",
                                                                "DELIVERY_MANAGER", "TL")
                                                ...
                                                .requestMatchers(HttpMethod.DELETE, "/api/support-tickets",
                                                                "/api/support-tickets/**")
                                                .hasAnyRole("ADMIN", "DELIVERY_HEAD", "DELIVERY_MANAGER", "TL")
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/timesheets/*/approve",
                                                ...
                                                // Project Member APIs
                                                .requestMatchers(HttpMethod.GET, "/api/project-members",
                                                                "/api/project-members/**")
                                                .hasAnyRole("ADMIN", "EXECUTIVE_VIEWER", "DELIVERY_HEAD",
                                                                "DELIVERY_MANAGER", "TL",
                                                                "TEAM_MEMBER")

                                                .requestMatchers(HttpMethod.POST, "/api/project-members",
                                                                "/api/project-members/**")
                                                .hasAnyRole("ADMIN", "DELIVERY_HEAD", "DELIVERY_MANAGER")

                                                .requestMatchers(HttpMethod.PUT, "/api/project-members",
                                                                "/api/project-members/**")
                                                .hasAnyRole("ADMIN", "DELIVERY_HEAD", "DELIVERY_MANAGER")

                                                .requestMatchers(HttpMethod.DELETE, "/api/project-members",
                                                                "/api/project-members/**")
                                                .hasAnyRole("ADMIN", "DELIVERY_HEAD", "DELIVERY_MANAGER")
                                ...
                                .exceptionHandling(exception -> exception
                                                .authenticationEntryPoint((request, response, authException) -> {
                                                        ...
                                                        response.getWriter()
                                                                        .write("{\"message\":\"Please login first\"}");
                                                })
